...
if __name__ == "__main__":
    # 指定输入和输出目录
    input_directory = "/Users/weitaikang/Desktop/WeitaiKang.github.io/experiences/sport/"  # 替换为你的 HEIC 文件目录
    output_directory = "/Users/weitaikang/Desktop/WeitaiKang.github.io/experiences/sport/"  # 替换为输出 PNG 文件的目录
